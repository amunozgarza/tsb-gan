...
def get_parameters():
    ...
    parser.add_argument('--dataset', type=str, default='folder', choices=["cifar10", "fake", "folder", "hdf5", "imagenet", "lfw", "lsun", "weizmann", "ucf11", "ucf101", "kinetics", "penn_action"],
    ...
    parser.add_argument('--inception_moments', default=' ', type=str)
    ...
    parser.add_argument('--freeze_condbn', type=str2bool, default=True)
